        ...
        if (scrollPosition >= 0 && scrollPosition < wrapper.offsetHeight) {
          sections.forEach((section, index) => {
            ...
            if (scrollPosition >= sectionStart && scrollPosition < sectionEnd) {
              ...
              // Only remove if not the last section or if scroll is before last section
              if (
                index !== lastSectionIndex ||
                scrollPosition < lastSectionIndex * windowHeight
              ) {
        ...
        <div className="max-w-xl mx-auto lg:ml-0 px-6 sm:px-8 lg:px-12 xl:px-16 pt-24">
          ...
          <div className="tabs_let-content min-h-screen flex items-center opacity-30 transition-opacity duration-500">
            <div>
              ...
              >
                When disasters strike in the Philippines, communication often
                fails first.
              </h5>

              <p className="text-[16px] md:text-[18px] text-gray-300 leading-relaxed">
                Power outages, downed cell towers, and lack of internet leave
                communities cut off, making it harder for families to call for
                help and for officials to know who needs urgent rescue. In many
                cases, delays in communication cost lives.
              </p>
            </div>
          </div>
          ...
          <div className="tabs_let-content min-h-screen flex items-center opacity-30 transition-opacity duration-500">
            <div>
              ...
              >
                Meralco Power Outages During Monsoon Floods Leave Thousands
                Disconnected
              </h5>

              <p className="text-[16px] md:text-[18px] text-gray-300 leading-relaxed mb-4">
                When monsoon rains hit in July 2025, over 167,000 households
                across Metro Manila and nearby provinces lost power. Floodwaters
                delayed repairs, leaving families unable to charge phones or
                reach rescuers when they needed help most.
              </p>

              <p className="text-[14px] md:text-[16px] text-gray-400 italic">
                Joann Villanueva on "Habagat rains cause power outages, affect
                167K Meralco customers"
              </p>
            </div>
          </div>
          ...
          <div className="tabs_let-content min-h-screen flex items-center opacity-30 transition-opacity duration-500">
            <div>
              ...
              >
                ResQWave is on a mission to bridge the communication divide in
                disasters.
              </h5>

              <p className="text-[16px] md:text-[18px] text-gray-300 leading-relaxed">
                Empowered by LoRa-powered community terminals, ResQWave ensures
                that even in the darkest moments—without cell service or the
                internet—communities can send instant, reliable alerts through
                trusted focal persons. Every SOS reaches responders quickly,
                every signal is clear, and every life gets a lifeline.
              </p>
