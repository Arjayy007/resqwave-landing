    ...
    <section id="how" className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-16 sm:py-20 lg:py-24 relative flex items-center z-20 min-h-screen">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          {/* Step 01 */}
          <div className="flex flex-col p-6 sm:p-8 lg:p-10 border-l border-b border-white border-dotted transition-all duration-300 hover:bg-blue-900/10">
            <div className="flex items-start gap-3 sm:gap-4 mb-4">
              <div className="bg-white text-black font-bold text-base sm:text-lg px-3 sm:px-4 py-1.5 sm:py-2 rounded-[5px] flex-shrink-0">
                01
              </div>
              <h3 className="text-lg sm:text-xl font-semibold pt-1 sm:pt-2">Community Terminal Setup</h3>
            </div>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mt-4 sm:mt-5">
          ...
          <div className="flex flex-col p-6 sm:p-8 lg:p-10 border-l border-b border-white border-dotted transition-all duration-300 hover:bg-blue-900/10">
            <div className="flex items-start gap-3 sm:gap-4 mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold pt-1 sm:pt-2">Sending Emergency Alerts</h3>
            </div>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mt-4 sm:mt-5">
          ...
          <div className="flex flex-col p-6 sm:p-8 lg:p-10 border-l border-b border-white border-dotted transition-all duration-300 hover:bg-blue-900/10">
            <div className="flex items-start gap-3 sm:gap-4 mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold pt-1 sm:pt-2">Alerts Reach Officials</h3>
            </div>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed mt-4 sm:mt-5">
