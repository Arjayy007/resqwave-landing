    ...
    >
      ...
      <div className="hidden md:flex md:w-55">
        ...
        >
          ...
          <span className="font-medium text-small ">ResQWave</span>
        </a>
      </div>
      {/* Mobile logo (no fixed width) */}
      <a
        href="/"
        className="flex md:hidden items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity"
      >
        <img src={resqwave_logo} alt="ResQWave Logo" className="h-auto w-7" />
        <span className="font-medium text-small ">ResQWave</span>
      </a>
      <div className="hidden md:block">
        <nav className="flex gap-8 text-base">
          <a
            href="#importance"
            className="relative text-white font-normal transition-all duration-300 hover:text-[#4283f1] group"
          >
            Importance
      ...
      {navOpen && (
        ...
        >
          <nav className="flex flex-col gap-4 w-full cursor-pointer">
            <a
              href="#importance"
              className="hover:text-blue-400 transition w-full font-semibold"
